...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(9,'announcement','announcement'),(3,'auth','group'),(2,'auth','permission'),(4,'contenttypes','contenttype'),(10,'notice','notice'),(5,'sessions','session'),(7,'user','characters'),(6,'user','menu'),(8,'user','userinfo');
